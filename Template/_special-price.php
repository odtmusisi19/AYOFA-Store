...
$in_cart = $Cart->getCartId($product->getCart('cart'));
...
<section id="special-price" >
    <div class="container " >
        ...
        <div class="grid">
            ...
            <div class="grid-item mobile <?php echo $item['item_brand'] ?? "Brand" ; ?>">
                <div class="item py-2 white shadow rounded"  style="width: 200px; ">
                    <div class="product font-rale">
                        ...
                        <div class="text-center">
                            ...
                            <form method="post">
                                ...
                                <?php
                                if (in_array($item['item_id'], $in_cart ?? []) && isset($_SESSION['login'])){
