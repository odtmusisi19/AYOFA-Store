...
<?php
  ...
  $id = $_GET['item_id'];
if (isset($_POST['prosestobuy'])){
  $nama_produk = mysqli_query($connection, "SELECT * FROM product WHERE item_id='$id' ");
  $get_nama = mysqli_fetch_array($nama_produk);
  $nama = $get_nama["item_name"];

  $insert = mysqli_query($connection, "INSERT INTO tabel_proses VALUES(NULL, '$nama') ");
   }
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                   <!--  <div class="col">
                        <button type="submit" name="prosestobuy" class="btn btn-danger form-control">Proceed to Buy</button>
                    </div> -->
                    <div class="col">
                        <?php
